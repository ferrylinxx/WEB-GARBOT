          ...
          <div className="relative z-10">
            ...
            <div className="mb-8">
              ...
              <h2 className="text-4xl md:text-6xl font-michroma font-bold mb-6">
                ¿Listo para iniciar con <br />
                <span className="gradient-text">GarBotGPT</span>?
              </h2>
              <p className="text-lg md:text-xl text-white/80 mb-4 max-w-3xl mx-auto leading-relaxed flex items-center justify-center gap-3">
                <svg className="w-6 h-6 text-yellow-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
                <span>GarBotGPT no es solo una IA: es una <span className="text-primary font-semibold">plataforma completa</span> creada para transformar ideas en soluciones,
                automatizar procesos y ofrecer respuestas precisas que marquen la diferencia.</span>
              </p>
            </div>
